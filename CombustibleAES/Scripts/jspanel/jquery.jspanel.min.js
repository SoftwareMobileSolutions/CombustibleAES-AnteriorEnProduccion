$.fn.jquery&&$.fn.uniqueId&&$.widget&&$.ui.mouse&&$.ui.draggable&&$.ui.resizable?console.info("Panel Cargado."):console.log("Error: jQuery or at least one jQuery UI component is not loaded! You need at least jQuery 1.9.1 and jQuery UI 1.9.2 (modules Core, Mouse, Widget, Draggable and Resizable).");
...
a.css("width");a.option.size.height=$(".jsPanel-content",a).css("height")},updateCustomData:function(a,c,b){var d=a.data("custom");d[c]=b;a.data("custom",d)},updateStateProps:function(a,c){a.status=c;a.option.panelstatus=c;a.data("panelstatus",c);a.alterClass("jsPanel-state-*","jsPanel-state-"+c)}};
